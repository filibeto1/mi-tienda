...
const CreateTipoModal = ({ onConfirm, onCancel }) => {
        ...
        <form onSubmit={handleSubmit}>
          <div className="edit-modal-body">
            ...
            <input
              ...
              placeholder="Ej: Cachuchas, Playeras, Termos, Gorras"
              autoFocus
            />
            
            <label className="edit-modal-label" style={{ marginTop: '15px' }}>Imagen del tipo (opcional)</label>
            <input
              type="file"
              accept="image/*"
...
export default CreateTipoModal;